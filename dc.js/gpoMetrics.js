// Manually recreate d3 category20 colors for easy reversing
...
function loadDC() {
  ...
  // REST endpoint set up for easy reference to most up-to-date authgroup data
  egam.utilities.getDataStash('availableAuthgroups',
    'gpoitems/authGroups');

  // Call the licenseitems Express route to get full collection of Pro licenses
  // This route returns a mongo collection of daily Pro license entitlements
